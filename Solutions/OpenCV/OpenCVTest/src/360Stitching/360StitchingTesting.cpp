...
//
//		cv::circle(temp, cv::Point2d(x, y), 10, cv::Scalar(0, 0, 255), -1);
//		cv::imshow("temp", temp);
//
...
//	stitching360->Init(mSrcFront.cols, mSrcFront.rows);
//
//	mDstFront = stitching360->Undistort(mSrcFront);
//	mDstBack = stitching360->Undistort(mSrcBack);
//	mDstLeft = stitching360->Undistort(mSrcLeft);
//	mDstRight = stitching360->Undistort(mSrcRight);
//
//	cv::imshow("mDstFront", mDstFront);
//	//cv::imshow("mSrcFront", mSrcFront);
//
//	/***************************************投影变换*****************************************************/
//	// 左侧
...
//	//for (int i = 0; i < 4; i++)
//	//{
//	//	cv::circle(mDstLeft, pSrcPointsLeft[i], 10, cv::Scalar(0, 0, 255), -1);
//	//}
//
//	//for (int i = 0; i < 4; i++)
//	//{
//	//	cv::circle(mDstLeft, pDstPointsLeft[i], 10, cv::Scalar(255, 0, 0), -1);
//	//}
//	//cv::imshow("mSrcLeft", mDstLeft);
//	
//
//	// 右侧
...
//	//for (int i = 0; i < 4; i++)
//	//{
//	//	cv::circle(mDstFront, mSrcPointsFront[i], 10, cv::Scalar(0, 0, 255), -1);
//	//}
//
//	//for (int i = 0; i < 4; i++)
//	//{
//	//	cv::circle(mDstFront, mDstPointsFront[i], 10, cv::Scalar(255, 0, 0), -1);
//	//}
//	//cv::imshow("mDstFront", mDstFront);
//
//	// 后方
